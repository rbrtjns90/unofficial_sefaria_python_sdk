...
class TextProcessor:
    ...
    def extract_verses(text_data: Dict) -> List[str]:
        ...
        if isinstance(text, list):
            return [str(verse).strip() for verse in text if verse and str(verse).strip()]
    ...
    @staticmethod
    def get_parallel_texts(hebrew: Union[str, List[str]], english: Union[str, List[str]]) -> List[Tuple[str, str]]:
